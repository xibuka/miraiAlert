...
struct UpdateAlarmView: View {
    ...
    init(alarm: AlarmEntity) {
        self.alarm = alarm
        self._selectedDate = State(initialValue: alarm.date ?? Date())
        self._selectedTime = State(initialValue: alarm.date ?? Date())
        self._note = State(initialValue: alarm.note ?? "")
        self._selectedSound = State(initialValue: alarm.soundName ?? "Default")
    }
...
#Preview {
    ...
    let sampleAlarm = AlarmEntity.createAlarm(
        context: context,
    ...
    return UpdateAlarmView(alarm: sampleAlarm)
